                            ...
                            {service.duration_minutes ? (
                              <span className="flex items-center gap-1">
                                ...
                                {service.duration_minutes} min
                                        ...
                                        <TableCell className="text-right font-medium">৳{typeof service.base_price === 'number' ? service.base_price.toFixed(2) : Number(service.base_price).toFixed(2)}</TableCell>
                          <TableCell>
                          ...
                          <TableCell>
                            <Badge variant={
                              ...
                              {booking.status}
                                        ...
                                        <TableCell className="text-right">৳{typeof booking.advance_paid === 'number' ? booking.advance_paid.toFixed(2) : Number(booking.advance_paid).toFixed(2)}</TableCell>
                          <TableCell className="text-right">
                            <div className="flex gap-2 justify-end">
                ...
                <SelectContent>
                  {services.filter(s => s.is_active).map(service => (
                    <SelectItem key={service.id} value={service.id}>
                                        {service.name} - ৳{typeof service.base_price === 'number' ? service.base_price.toFixed(2) : Number(service.base_price).toFixed(2)}
                    </SelectItem>
                  ))}
                </SelectContent>
              </Select>
