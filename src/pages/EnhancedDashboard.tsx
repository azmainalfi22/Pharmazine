  ...
  const loadDashboardData = async (silent = false) => {
    ...
    try {
      ...
      try {
        ...
        logger.error("Error loading realtime stats:", error);
      }
      ...
      try {
        ...
        logger.error("Error loading hourly sales:", error);
      }
      ...
      try {
        ...
        const dbUp =
          healthData.database_ok === true ||
          healthData.database === "Connected" ||
          (typeof healthData.database === "string" &&
            healthData.database.includes("REST fallback"));
        setSystemHealth({
      ...
      // Load stats (required permission + DB; failure should not break the whole dashboard)
      try {
      ...
      try {
        ...
        logger.debug("Expiry alerts not available");
      }
      ...
      try {
        ...
        logger.debug("Pharmacy statistics not available");
      }
